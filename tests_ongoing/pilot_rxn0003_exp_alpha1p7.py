"""Pilot trace for 2 additional exp-only variants on rxn0003 stage-1
with α=1.7 (the upstream RepelPotential default + May 2026 ablation
choice). Companion to pilot_rxn0003_repel_variants.py — same harness
pattern, same output dir.

Variants:
   1. exp_a1p7_covalent  α=1.7, β=0, r₀=covalent
   2. exp_a1p7_r0_1.0    α=1.7, β=0, r₀=1.0 Å (constant)
"""
import json
import os
import time
...
VARIANTS = [
    dict(name='exp_a1p7_covalent', alpha=1.7, beta=0.0, r0=None),
    dict(name='exp_a1p7_r0_1.0',   alpha=1.7, beta=0.0, r0=1.0),
]
...
def main():
    ...
    print('\n=== SUMMARY (α=1.7 exp-only variants) ===', flush=True)
