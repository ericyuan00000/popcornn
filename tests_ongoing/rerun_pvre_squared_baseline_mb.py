"""Single-stage pvre_squared baseline on Müller-Brown.

Companion to ``rerun_pvre_baseline_mb.py``. Same knobs, only the
integrand differs:

  pvre_squared, lr=1e-2, 18-param MLP (n_embed=2 depth=2),
  n_iter=600, threshold=1e-2, patience=10, 3 seeds

Output: /pscratch/sd/e/ericyuan/temp/popcornn_huber/mb_pvre_squared_rerun/
"""
import copy
import json
import os
...
OUT_BASE = '/pscratch/sd/e/ericyuan/temp/popcornn_huber/mb_pvre_squared_rerun'
