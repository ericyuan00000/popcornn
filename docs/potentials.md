...
| `repel` | All-atom soft-repulsive potential. **Use this with `path_ode_names: geodesic` as a pre-step to fix atom clashes.** |
...
`path_ode_names: geodesic`, performs **geodesic interpolation**: it
